...
const QUEUE_COLS = "id,x,y,status,story,artist_name,artist_email,artist_location,image_path,pending_image_path,pending_story";
...
async function fetchQueue(db: ReturnType<typeof supabaseAdmin>): Promise<Row[]> {
  ...
  return ((safe.data as Omit<Row, "pending_image_path" | "pending_story">[]) ?? []).map((r) => ({ ...r, pending_image_path: null, pending_story: null }));
}

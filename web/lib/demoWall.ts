...
export type TileInfo = {
  ...
  stage?: string; uuid?: string; votes?: number; voted?: boolean;
};
...
export function createDemoWall(GRID = 24, fillPct = 0.7, tilePx = 96): Wall {
  const TILE_PX = tilePx, HI = GRID * TILE_PX, N_TOTAL = GRID * GRID;
